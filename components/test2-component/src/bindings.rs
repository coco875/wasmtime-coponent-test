...
pub fn init_actor(a: &Actor) -> () {
    unsafe {
        ...
        unsafe { wit_import0((a).handle() as i32) };
    }
}
#[doc(hidden)]
...
pub unsafe fn _export_actor_init_cabi<T: Guest>(arg0: i32, arg1: f32, arg2: f32) {
    ...
    T::actor_init(
        {
            handle0 = unsafe {
                spaghettikart::module::iactor::Actor::from_handle(arg0 as u32)
            };
            &handle0
        },
        arg1,
...
macro_rules! __export_world_mod_world_cabi {
    ($ty:ident with_types_in $($path_to_types:tt)*) => {
        ...
        #[unsafe (export_name = "actor-init")] unsafe extern "C" fn
        export_actor_init(arg0 : i32, arg1 : f32, arg2 : f32,) { unsafe {
        $($path_to_types)*:: _export_actor_init_cabi::<$ty > (arg0, arg1, arg2) } }
        #[unsafe (export_name = "actor-update")] unsafe extern "C" fn
        export_actor_update(arg0 : i32,) { unsafe { $($path_to_types)*::
        _export_actor_update_cabi::<$ty > (arg0) } } #[unsafe (export_name =
        "actor-render")] unsafe extern "C" fn export_actor_render(arg0 : i32,) { unsafe {
        $($path_to_types)*:: _export_actor_render_cabi::<$ty > (arg0) } } };
    };
}
#[doc(hidden)]
                ...
                pub fn outside_init(&self, x: f32, y: f32) -> () {
                    unsafe {
                        ...
                        unsafe extern "C" {
                            ...
                            fn wit_import0(_: i32, _: f32, _: f32);
                        }
                        #[cfg(not(target_arch = "wasm32"))]
                        unsafe extern "C" fn wit_import0(_: i32, _: f32, _: f32) {
                            unreachable!()
                        }
                        unsafe {
                            wit_import0(
            ...
            impl Actor {
                ...
                pub fn set_x(&self, x: f32) -> () {
                    unsafe {
                        ...
                        #[cfg(not(target_arch = "wasm32"))]
                        unsafe extern "C" fn wit_import0(_: i32, _: f32) {
                            unreachable!()
                        }
                        unsafe { wit_import0((self).handle() as i32, _rt::as_f32(&x)) };
                    }
                }
            }
            impl Actor {
            ...
            impl Actor {
                ...
                pub fn set_y(&self, y: f32) -> () {
                    unsafe {
                        ...
                        unsafe { wit_import0((self).handle() as i32, _rt::as_f32(&y)) };
                    }
                }
            }
        }
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:spaghettikart:module:mod-world:encoded world"
)]
#[doc(hidden)]
